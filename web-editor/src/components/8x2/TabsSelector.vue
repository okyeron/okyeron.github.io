<template>
  <div :class="['container', { 'column vertical': vertical, row: !vertical }]">
    ...
    <RadioGroup v-model="value" :options="options"
      :class="['tab-selector', { 'column vertical': vertical, row: !vertical }]" input-class="radio"
...
import type { RadioGroupOption, RadioOptionValueType } from 'components/8x2/RadioGroup.vue';
import RadioGroup from 'components/8x2/RadioGroup.vue';
