...
<!-- 
 ...
 -->
      ...
      <div class="bottom-border-container row align-center justify-between">
        <header class="title">
          <!-- <OMX27 class="japanese" /> -->

          <div class="ayy-by-two">
            <span>({{ info?.model ?? 'OMX-27' }})</span> <span>v{{ info?.version }}</span>
          </div>
        </header>
...
import OMX27 from '@/components/OMX27.vue';
...
const firstFivePotentiometers = computed(() => props.potentiometers.slice(0, 5));
