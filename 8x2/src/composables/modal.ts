import { Component, computed, ref, shallowRef, watchEffect } from 'vue';
...
export const useModal = () => {
  const setModalContent = async (newContent: ModalContent, config: ModalConfig = defaultConfig): Promise<boolean> => {
